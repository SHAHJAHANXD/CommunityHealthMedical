                    ...
                    <div class="col-xl-7 col-lg-6">
                        <div class="text-left">
                            ...
                            <div class="mt-3">
                                ...
                                @endif
                                <h5 style="font-weight: 700;">Contact Us for Appointment</h5>
                                <p>kindly provide us with the following details for the first time Patient registeration and <br>
                                        forward us by attaching the Emirates ID and Insurance Card details at your earliest <br>
                                        convenience to complete the registration.</p>
                                <form action="/offer-booking" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <input name="product_id" type="hidden" class="form-control" value="{{$detailedProduct->id}}">
                                    <div style="margin-bottom: 17px;" class="row">
                                        <div class="col">
                                            <input name="name" type="text" class="form-control" placeholder="Name">
                                        </div>
                                        <div class="col">
                                            <input name="dob" type="text" class="form-control" onfocus="(this.type='date')" placeholder="Date Of Birth">
                                        </div>
                                    </div>
                                    <div style="margin-bottom: 17px;" class="row">
                                        <div class="col">
                                        ...
                                        <div class="col">
                                            <input name="emirates" type="text" class="form-control" placeholder="Emirates ID">
                                        </div>
                                    </div>
                                    <div style="margin-bottom: 17px;" class="row">
                                        <div class="col">
                                        ...
                                        <div class="col">
                                            <input name="insurance" type="text" class="form-control" placeholder="Insurance">
                                        </div>
                                    </div>
                                    <div style="margin-bottom: 17px;" class="row">
                                        <div class="col">
                                    ...
                                    <div style="margin-bottom: 17px;" class="row">
                                        <div class="col">
                                            <input name="reason" type="text" class="form-control" placeholder="Reason of consult with Doctor">
                                        </div>
                                        <div class="col">
                                            <input name="emergency_name" type="text" class="form-control" placeholder="Emergency Person Name ">
                                        </div>
                                    </div>
                                    <div style="margin-bottom: 17px;" class="row">
                                        <div class="col">
                                            <input name="emergency_num1" type="text" class="form-control" placeholder="Emergency Person Contact no">
                                        </div>
                                        <div class="col">
                                            <input name="emergency_num2" type="text" class="form-control" placeholder="Emergency Person Contact no">
                                        </div>
                                    </div>
                                    <div style="margin-bottom: 17px;" class="row">
                                        <div class="col">
                                            <input name="relation" type="text" class="form-control" placeholder="Relation">
                                        </div>
                                        <div class="col">
                                            <input name="timedate" type="text" class="form-control" onfocus="(this.type='date')" placeholder="Time and Date">
                                        </div>
                                    </div>
                                    <div style="margin-bottom: 17px;" class="row">
                                        <div class="col">
                                            <p align="center"><button style="width: 48%;border-radius: 25px;font-size: 17px;letter-spacing: 2px;font-weight: 600;color: black;" class="btn btn-primary shadow-md">Confirm Booking</button></p>
                                        </div>
                                    </div>
                                </form>
                            </div>
