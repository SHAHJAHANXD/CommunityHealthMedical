...
@endif
<!-- Top Bar -->
<div style="background: #2dd24c !important;color: white !important;font-weight: 700;" class="top-navbar bg-white border-bottom border-soft-secondary z-1035">
    <div class="container">
        <div class="row">
                ...
                <ul class="list-inline d-flex justify-content-between justify-content-lg-start mb-0">
                    ...
                    <li class="list-inline-item dropdown mr-3" id="lang-change">
                        ...
                        <a href="javascript:void(0)" class="dropdown-toggle text-reset py-2" data-toggle="dropdown" data-display="static">
                            ...
                            <span class="">{{ \App\Language::where('code', $locale)->first()->name }}</span>
                        </a>
            ...
            <div class="col-5 text-right d-none d-lg-block">
                <ul class="list-inline mb-0 h-100 d-flex justify-content-end align-items-center">
                    ...
                    @else
                        ...
                        <li class="list-inline-item">
                            <a href="{{ route('user.registration') }}" class="text-reset d-inline-block">{{ translate('Registration')}}</a>
                        </li>
                    @endauth
                </ul>
            </div>
...
<header class="@if(get_setting('header_stikcy') == 'on') sticky-top @endif z-1020 bg-white border-bottom shadow-sm">
    ...
    @if ( get_setting('header_menu_labels') !=  null )
        <div style="background: #0c6d9d !important;color: white;" class="bg-white border-top border-gray-200 py-1">
            <div class="container">
